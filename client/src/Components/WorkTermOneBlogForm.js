    ...
    return (
      ...
      <div className={this.state.darkMode ? "tabContentDark" : "tabContent"}>
          ...
          <div className="postDiv" id="postDiv">
            ...
            <img  alt="Adding New Job Request Light" src={require("./Content/AddingJobRequest.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>

            <p className={this.state.darkMode ? "darkText" : "lightText"}>{webDevelopmentFour}</p> 
            <img  alt="Dark Mode View Client" src={require("./Content/Dark_View.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 
            <img  alt="Light All Clients View" src={require("./Content/AllClients.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 
            
            <p className={this.state.darkMode ? "darkText" : "lightText"}>{webDevelopmentFive}</p> <br></br>
            <img  alt="Dark Mode Create Client" src={require("./Content/Dark_Create.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 
            <img  alt="Expandable Client Policy Options" src={require("./Content/ExpandablePolicyOptions.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 

            <p className={this.state.darkMode ? "darkText" : "lightText"}>{webDevelopmentSix}</p> 
            <img  alt="Pagination" src={require("./Content/Pagination_RequestJSON.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 
            <img  alt="Light Download to CSV" src={require("./Content/DownloadToCSV.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/> 
            <img  alt="Downloaded CSV" src={require("./Content/DownloadedCSV.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
          ...
          <div className="postDiv" id="postDiv">
            ...
            <img  alt="Xmas sweaters" src={require("./Content/christmasSweaters.png")} style={{border: "1px solid grey", width: "50%", height: "50%"}}/>
            </div>
    </div>
    </MediaQuery>
