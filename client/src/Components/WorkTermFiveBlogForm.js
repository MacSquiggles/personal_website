          ...
          <MediaQuery query='(min-width: 1225px)'>
            <div className={this.state.darkMode ? "tabContentDark" : "tabContent"}>
              ...
              <div className="postDiv" id="postDiv">
                ...
                <img  alt="Logger tool home" src={require("./Content/breakpointTargeting/loggerTool1.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{breakpointTargeting4}</p>
                <img  alt="Search for test" src={require("./Content/breakpointTargeting/loggerTool2.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{breakpointTargeting5}</p>
                <img  alt="First session for test" src={require("./Content/breakpointTargeting/loggerTool3.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Second session for test" src={require("./Content/breakpointTargeting/loggerTool4.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{breakpointTargeting6}</p>
                <img  alt="Session video player" src={require("./Content/breakpointTargeting/loggerTool5.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Full screen viewer" src={require("./Content/breakpointTargeting/loggerTool6.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{breakpointTargeting7}</p>
                <img  alt="Full session csv file" src={require("./Content/breakpointTargeting/spreadsheet1.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Specific session csv file" src={require("./Content/breakpointTargeting/spreadsheet2.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{breakpointTargeting8}</p>
              </div>
              <div className="postDiv" id="postDiv">
                ...
                <img  alt="Parse file data flow" src={require("./Content/assetQueue/bank1.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{assetQueue4}</p>
                <img  alt="Bank data flow" src={require("./Content/assetQueue/bank2.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{assetQueue5}</p>
                <img  alt="Branch data flow" src={require("./Content/assetQueue/bank3.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{assetQueue6}</p>
                <img  alt="Full ADF pipeline" src={require("./Content/assetQueue/bank4.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{assetQueue7}</p>
              </div>
              <div className="postDiv" id="postDiv">
                ...
                <img  alt="Dashboard" src={require("./Content/dynamicData/tech1.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData3}</p>
                <img  alt="Open job positions" src={require("./Content/dynamicData/tech2.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Add new position" src={require("./Content/dynamicData/tech3.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="View job position" src={require("./Content/dynamicData/tech4.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData4}</p>
                <img  alt="Upload a package" src={require("./Content/dynamicData/tech5.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Show candidates" src={require("./Content/dynamicData/tech6.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData5}</p>
                <img  alt="Committee member" src={require("./Content/dynamicData/tech7.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <img  alt="Add interview time" src={require("./Content/dynamicData/tech8.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData6}</p>
                <img  alt="Closed job positions" src={require("./Content/dynamicData/tech9.png")} style={{border: "1px solid grey", width: "80%", height: "80%"}}/>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData7}</p>
                <p className={this.state.darkMode ? "darkText" : "lightText"}>{dynamicData8}</p>
              </div>
              <div className="postDiv" id="postDiv">
